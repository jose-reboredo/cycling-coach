...
| 11 | In flight | 2026-05-03 | v10.13.0 → … | Internal (housekeeping) | Security audit + 5-UPDATE WHERE hardening; +158 contract tests; README + Confluence rewrite to professional standard; route generation explicitly deferred to a dedicated sprint |
| 12 | Planned | TBD | TBD | A (route generation rebuild) | Reserved for the end-to-end route-generation rebuild — fixture-based harness, geocoding + ORS + scoring + post-validation + saved-route ranking + picker UX redesigned together rather than patched in isolation |
