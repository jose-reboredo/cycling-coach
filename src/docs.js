...
<tr><td><strong>v9.7.5</strong></td><td>✅ <strong>Shipped 2026-05-01</strong> — <a href="https://github.com/jose-reboredo/cycling-coach/issues/67">#67</a> + <a href="https://github.com/jose-reboredo/cycling-coach/issues/68">#68</a> + <a href="https://github.com/jose-reboredo/cycling-coach/issues/69">#69</a> iOS Safari hardening (PATCH-tier hotfix for v9.7.3 visual issues). BottomNav padding for Safari bottom toolbar; date/time native input strip; visualViewport-aware modal sizing.</td></tr>
<tr><td colspan="2"><em><strong>Naming convention corrected 2026-05-01</strong>: feature releases now MINOR-bump (was incorrectly using PATCH from v9.7.1–v9.7.3). v9.8.0+ follows strict SemVer per <code>CONTRIBUTING.md</code>. Past releases stay frozen as labelled.</em></td></tr>
<tr><td><strong>v9.8.0</strong></td><td><a href="https://github.com/jose-reboredo/cycling-coach/issues/60">#60</a> follow-up — AI description endpoint (system-paid Haiku) + Edit UX (PATCH wired in drawer) + Route picker integration. ~3h.</td></tr>
<tr><td><strong>v9.9.0</strong></td><td><a href="https://github.com/jose-reboredo/cycling-coach/issues/61">#61</a> Personal scheduler at <code>/dashboard/schedule</code> aggregating club RSVPs + AI plan items + goals. ~12h.</td></tr>
<tr><td><strong>v9.10.0</strong></td><td><a href="https://github.com/jose-reboredo/cycling-coach/issues/56">#56</a> Clubs share/invite flow (Detail → Share Sheet → Link Copied → Invitee Landing). ~6h.</td></tr>
<tr><td><strong>v9.11.0</strong></td><td>Sprint 5.5 — <a href="https://github.com/jose-reboredo/cycling-coach/issues/64">#64</a> Landing page copy rewrite (de-jargonised for Sofia + Léa). ~4h. Optional pair with <a href="https://github.com/jose-reboredo/cycling-coach/issues/65">#65</a> visual differentiation if discovery doc lands first.</td></tr>
<tr><td><strong>Effort total</strong></td><td>~46h across 9 releases. Shipped: v9.7.0–v9.7.5 (Schedule month → multi-view → nav/icons → event model → 2 hotfixes). Ahead: v9.8.0 → v9.11.0 (AI description + personal scheduler + share/invite + Sprint 5.5 Landing rewrite). +6h vs original ~40h estimate due to the two hotfix releases absorbing iOS Safari edge cases.</td></tr>
<tr><td><strong>ADRs to lock</strong></td><td>ADR-S5.1 cron failure mode ✅ (Sprint 6); ADR-S5.2 readiness-dot threshold ✅ (Sprint 6); ADR-S5.3 AI-description prompt shape + cost ceiling (v9.8.0); ADR-S5.4 AI plan parsing contract (v9.9.0)</td></tr>
<tr><td><strong>Risk</strong></td><td>iOS Safari handling — visualViewport API + safe-area-inset pattern needs real-device verification on iPhone with bottom-toolbar Safari mode. Deferred personal scheduler (v9.9.0) is the largest remaining piece — new top-level route + aggregation endpoint.</td></tr>
...
<tr><td><strong>Optional pair</strong></td><td>Visual language refresh from <a href="https://github.com/jose-reboredo/cycling-coach/issues/65">#65</a> if the discovery doc lands ahead of v9.11.0 ship date.</td></tr>
</table>
...
<tr><td><strong>Releases</strong></td><td>v9.12.0 (cron handler + readiness dots + trend arrows — Phase 4) → v9.13.0 (Circle Note + Metrics tab + Migration 0008 — Phase 5 part 1) → v9.14.0 (post-ride callout — Phase 5 part 2). PATCH-tier hotfix bumps in between as needed.</td></tr>
